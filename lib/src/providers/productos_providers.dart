...
class ProductosProvider {
  final String _url = 'https://flutter-varios-acf7f-default-rtdb.firebaseio.com';
  ...
  Future<String?> subirImage(File imagen)async {
    final url = Uri.parse('https://api.cloudinary.com/v1_1/diamohcrn/image/upload?upload_preset=cb8khgxu');
    final mimeType = mime(imagen.path) as String; //image/jpeg
